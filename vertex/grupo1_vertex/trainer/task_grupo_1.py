"""
trainer/task.py
Vertex AI Custom Job — Group 1 executions (basic length features, 1-1 to 1-6).
Reads data from gs://<GCP_BUCKET>, saves results to gs://<GCP_BUCKET>/grupo_1/
"""
...
N_FOLDS     = 5
N_JOBS      = 2    # grupo 1 solo tiene 6 features, 2 workers son más que suficientes
RANDOM_SEED = 8
...
FEATURE_SETS = {"group1": FEATURES_GROUP1}

# ─── Todas las ejecuciones del grupo 1 (sin PCA) ─────────────
EXECUTIONS = [
    ("1-2", "group1", None, "knn"),
