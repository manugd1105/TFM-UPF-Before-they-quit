"""
trainer/task.py
Vertex AI Custom Job — Group 3 executions (NLP features, 3-1 to 3-24).
Reads data from gs://<GCP_BUCKET>, saves results to gs://<GCP_BUCKET>/grupo_3/
"""
...
FEATURE_SETS = {"group3": FEATURES_GROUP3}
...
def run_execution(exec_id, feature_group, pca_mode, model_type, train_raw, test_raw):
    ...
    # Write to temp dir, then upload all files to GCS
...
if __name__ == "__main__":
    ...
    # Pre-calcular ejecuciones ya completadas en GCS (tienen Dashboard output)
