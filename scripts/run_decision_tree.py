...
--------------------
Runs ALL Decision Tree executions (all groups, all PCA configs).
Repeats everything — does not skip already completed runs.

Iterations:
  - Decision Tree: 50  (~3% of 1800 combinations)
"""
...
OUTPUT_BASE      = "./05_outputs_modeling/Decision tree"
...
# ============================================================
# EXECUTIONS — ALL Decision Tree (all groups)
# ============================================================
EXECUTIONS = [
    # Group 1
    ("1-3",  "group1", None,      "decision_tree"),
...
if __name__ == "__main__":
    print(f"Running {len(EXECUTIONS)} Decision Tree executions (all groups)")
    ...
    for _ in range(5):
        os.system("afplay -v 10 /System/Library/Sounds/Glass.aiff")
