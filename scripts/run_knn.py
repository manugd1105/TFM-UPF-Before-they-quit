...
run_knn.py
----------
Runs ALL KNN executions (all groups, all PCA configs).
Repeats everything — does not skip already completed runs.

Iterations:
  - KNN: 24  (covers ~50% of 48 combinations: 8 n_neighbors × 2 weights × 3 metrics)
"""
...
OUTPUT_BASE      = "./05_outputs_modeling/KNN"
...
if __name__ == "__main__":
    print(f"Running {len(EXECUTIONS)} KNN executions (all groups)")
