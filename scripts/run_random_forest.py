...
--------------------
Runs ALL Random Forest executions (all groups, all PCA configs).
Repeats everything — does not skip already completed runs.

Iterations:
  - Random Forest: 50  (~9% of 576 combinations)
"""
...
OUTPUT_BASE      = "./05_outputs_modeling/Random forest"
...
if __name__ == "__main__":
    print(f"Running {len(EXECUTIONS)} Random Forest executions (all groups)")
